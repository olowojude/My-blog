...
form .form-row .fieldBox > label  {
  text-transform: inherit;
}
form .form-row .fieldBox + .fieldBox {
  padding-top: 0;
}
form .form-row .fieldBox:not(:first-child) {
  border-top: none;
  padding-right: 2vw;
}
...
.djangocms-admin-style .submit-row .deletelink-box .deletelink[disabled]:before, .djangocms-admin-style .submit-row .deletelink-box .deletelink[disabled]:hover:before, .djangocms-admin-style .submit-row .deletelink-box .deletelink[disabled]:focus:before, .djangocms-admin-style .submit-row .deletelink-box .deletelink[disabled]:active:before {
  opacity: 0.4 true;
}
...
#header .toolbar-item-navigation li ul {
  ...
  background: rgba(var(--dca-white), 0.97);
...
.filebrowser #id_new_folder[disabled]:before, .filebrowser #id_new_folder[disabled]:hover:before, .filebrowser #id_new_folder[disabled]:focus:before, .filebrowser #id_new_folder[disabled]:active:before {
  opacity: 0.4 true;
}
...
.filebrowser .clipboard button.pastelink[disabled] {
  color: var(--dca-gray-lighter) !important;
}
...
.filerFile .related-lookup[disabled]:before, .filerFile .related-lookup[disabled]:hover:before, .filerFile .related-lookup[disabled]:focus:before, .filerFile .related-lookup[disabled]:active:before,
.filerFile .filerClearer[disabled]:before,
.filerFile .filerClearer[disabled]:hover:before,
.filerFile .filerClearer[disabled]:focus:before,
