...
@font-face {
  ...
  src: url("../../fonts/3.11.0/django-cms-iconfont.eot");
  src: url("../../fonts/3.11.0/django-cms-iconfont.eot#iefix") format("eot"), url("../../fonts/3.11.0/django-cms-iconfont.woff2") format("woff2"), url("../../fonts/3.11.0/django-cms-iconfont.woff") format("woff"), url("../../fonts/3.11.0/django-cms-iconfont.ttf") format("truetype"), url("../../fonts/3.11.0/django-cms-iconfont.svg#django-cms-iconfont") format("svg");
  font-weight: normal;
  font-style: normal;
}
...
.cms-icon-moon:before, html:not([data-color-scheme]) .cms-toolbar-item-dark-mode-toggle .cms-toggle:before, html[data-color-scheme=light] .cms-toolbar-item-dark-mode-toggle .cms-toggle:before {
  content: "\E01A";
}
...
.cms-icon-sun:before, html[data-color-scheme=dark] .cms-toolbar-item-dark-mode-toggle .cms-toggle:before {
  content: "\E026";
}
...
div.cms .cms-messages {
  ...
  background: rgba(var(--dca-black), 0.74);
...
div.cms .cms-screenblock {
  ...
  height: 100%;
  background-color: var(--dca-black);
  background: rgba(var(--dca-black), 0.9);
}
...
div.cms .cms-droppable:before {
  ...
  border-left: 8px solid var(--dca-primary);
}
